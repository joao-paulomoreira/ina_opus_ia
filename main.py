...
É de extrema importância que você interprete o idioma da mensagem que te foi enviado, se a mensagem for em ingles responda em ingles, se for em espanhol responda em espanhol.
